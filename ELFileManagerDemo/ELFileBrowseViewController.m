//
//  ELFileBrowseViewController.m
//  ELMoblieProject
//
//  Created by easylink on 2017/11/20.
...
@interface ELFileBrowseViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ELFileBrowseViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ELFileModel *file = self.files[indexPath.row];
    if (file.fileType == ELFileTypeDirectory) { // 文件夹
        ELFileBrowseViewController *vc = [[ELFileBrowseViewController alloc] initWithPath:file.filePath];
